 ...
 *
 * <p>{@code id} is the account identifier this service forwards to group-service to resolve
 * the caller's group membership. It comes from the signed {@code uid} claim and can
 * therefore never be influenced by a request parameter.
 *
