 ...
 *
 * <p>Deliberately matches auth-service's and group-service's {@code ErrorResponse} field for
 * field: a SplitExpense client talks to several services and should not need per-service
 * error handling.
 *
