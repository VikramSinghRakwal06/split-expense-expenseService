...
public interface AuditLogRepository
    ...
    /**
     * Reconstructs a transaction's full history, oldest first, for support and incident
     * review.
     *
     * @param transactionId the transaction to reconstruct
     * @param pageable      page number and size; sort is fixed to {@code createdAt} ascending
     *                      by {@code idx_audit_logs_transaction_created} regardless of what
     *                      is passed
     * @return the requested page of this transaction's audit trail
     */
